...
export interface IXcmInterface extends Interface {
  getFunction(nameOrSignature: "execute" | "weighMessage"): FunctionFragment;

  encodeFunctionData(
    functionFragment: "execute",
    values: [BytesLike, WeightStruct]
  ): string;
  encodeFunctionData(
...
export interface IXcm extends BaseContract {
  ...
  execute: TypedContractMethod<
    [message: BytesLike, weight: WeightStruct],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[message: BytesLike], [WeightStructOutput], "view">;
