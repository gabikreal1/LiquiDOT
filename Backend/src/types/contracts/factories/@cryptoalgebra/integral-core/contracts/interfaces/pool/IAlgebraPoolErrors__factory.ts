...
} from "../../../../../../@cryptoalgebra/integral-core/contracts/interfaces/pool/IAlgebraPoolErrors";
...
export class IAlgebraPoolErrors__factory {
  ...
  static createInterface(): IAlgebraPoolErrorsInterface {
    return new Interface(_abi) as IAlgebraPoolErrorsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IAlgebraPoolErrors {
    return new Contract(address, _abi, runner) as unknown as IAlgebraPoolErrors;
  }
}
