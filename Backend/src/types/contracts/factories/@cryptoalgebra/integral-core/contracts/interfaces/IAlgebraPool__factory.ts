...
import type {
  IAlgebraPool,
  IAlgebraPoolInterface,
} from "../../../../../@cryptoalgebra/integral-core/contracts/interfaces/IAlgebraPool";
...
export class IAlgebraPool__factory {
  ...
  static createInterface(): IAlgebraPoolInterface {
    return new Interface(_abi) as IAlgebraPoolInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IAlgebraPool {
    return new Contract(address, _abi, runner) as unknown as IAlgebraPool;
  }
}
